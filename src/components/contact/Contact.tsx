...
function Contact() {
  ...
  const sendEmail = (e: FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .sendForm("service_hsra6p9", "template_6jripko", formRef.current!, {
        publicKey: "dFvmUotImCccDzZ0N",
      })
      .then(
        () => {
          setIsSuccess(true);
  ...
  return (
    ...
    >
      <motion.div className="text-container" variants={variants}>
        ...
        <motion.div className="fields" variants={variants}>
          <motion.div className="item" variants={variants}>
            <h3>Email</h3>
            <p>shivamsb2003@gmail.com</p>
          </motion.div>
          <motion.div className="item" variants={variants}>
            <h3>Address</h3>
            <p>New Delhi, India</p>
